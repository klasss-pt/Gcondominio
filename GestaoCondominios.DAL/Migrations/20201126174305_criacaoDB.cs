    ...
    public partial class criacaoDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Contribuinte = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AlugarId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Alugueres", x => x.AlugarId);
                    table.ForeignKey(
                        name: "FK_Alugueres_Meses_MesId",
                        column: x => x.MesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartamentos_Utilizador_MoradorId",
                        column: x => x.MoradorId,
                        principalTable: "Utilizador",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Apartamentos_Utilizador_ProprietarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Eventos_Utilizador_UtilizadorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Servicos_Utilizador_UtilizadorId",
                        column: x => x.UtilizadorId,
                        principalTable: "Utilizador",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Veiculos_Utilizador_UtilizadorId",
                        column: x => x.UtilizadorId,
                        principalTable: "Utilizador",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AluguerAlugarId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pagamentos_Alugueres_AluguerAlugarId",
                        column: x => x.AluguerAlugarId,
                        principalTable: "Alugueres",
                        principalColumn: "AlugarId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pagamentos_Utilizador_UtilizadorId1",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "7839081f-780d-4742-aaa8-8573da8a8475", "dfb3a5d3-5d54-4bec-b5d5-f59d1628a9ea", "Morador do Prédio", "Morador", "MORADOR" },
                    { "78bcd831-c883-4cc5-a798-a666934e40a0", "2b7e3da1-e404-46eb-a381-233fdb9276fa", "Responsavel do Prédio", "Responsavel Prédio", "RESPONSAVEL PREDIO" },
                    { "31d15343-ef31-4e3e-a526-f831afb54be5", "4e8aa498-9617-4bad-b0d1-61b46bb66bf8", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pagamentos_AluguerAlugarId",
                table: "Pagamentos",
                column: "AluguerAlugarId");

            migrationBuilder.CreateIndex(
                name: "IX_Pagamentos_UtilizadorId1",
                table: "Pagamentos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Utilizador_Contribuinte",
                table: "Utilizador",
                column: "Contribuinte",
                unique: true);
